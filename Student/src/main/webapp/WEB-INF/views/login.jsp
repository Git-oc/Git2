...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/host.css">
        ...
        <div >
            ...
            <form class=" animated rollIn" data-validator-option="{theme:'yellow_right_effect',stopOnError:true}">
                <div class="form-group">
                    <input type="text" class="form-control"  placeholder="用户名" data-rule="用户名:required;digits" autocomplete="off" id = "userid">
                </div>
                <div class="form-group">
                    <input type="password" class="form-control" placeholder="密码" data-rule="密码:required;password" autocomplete="off" id = "password">
                </div>
                <fieldset>
